...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      <PageHeader>
        <PageHeaderHeading className="max-w-2xl">Welcome back</PageHeaderHeading>
        <PageHeaderDescription>
          Sign in to your QuikShare account to access your shared content and continue where you left off.
        </PageHeaderDescription>
      </PageHeader>
